...
Este coeficiente evalúa la participación relativa de la variable económica de interés en la actividad económica dentro del territorio de referencia, a la cual s ele resta la participación de toda la economía del territorio objetivo en el territorio d referencia. De esta manera, si la actividad económica es más relevante que el resto de la actividad, el coeficiente obtendrá valores positivos e indicará cierto nivel de concentración. El coeficiente HH modificado se expresa como:
